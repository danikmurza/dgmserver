...
class Booking extends React.Component {
    ...
    OnSubmit =  (e) => {
        console.log(e)
        e.preventDefault()
        userAction.myAccount(this.state)
                            ...
                            <div className="col-lg-12 ">
                                <form className="needs-validation" noValidate>
                                    <div className="row g-3">
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="tel" className="form-label">Phone <span
                                                className="text-muted"/></label>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="vehicleLocation" className="form-label">Vehicle
                                                Location</label>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control input" id="year"
                                                   placeholder="Year"
                                                   required
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control input" id="make"
                                                   placeholder="Make"
                                                   required
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control input" id="model"
                                                   placeholder="Model"
                                                   required
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control input" id="color"
                                                   placeholder="Color"
                                                   required
